...
Where:
- **VERSION**: Dashed version number (e.g. `2-3-0` for v2.3.0)
...
```
cc-agent-2-3-0-linux-amd64      # Linux x86_64
cc-agent-2-3-0-linux-arm64      # Linux ARM64 (Raspberry Pi, AWS Graviton)
cc-agent-2-3-0-darwin-arm64     # macOS Apple Silicon
cc-agent-2-3-0-freebsd-amd64    # FreeBSD x86_64
```
...
chmod +x cc-agent-2-3-0-linux-amd64
